...
const BOT_DOCS = {
  ...
  screenshots: [
    ...
    { src: 'docs/ss2.jpg', caption: 'Fitur Downloader' },
    { src: 'docs/ss3.jpg', caption: 'AI Chat & Gemini' },
    { src: 'docs/ss4.jpg', caption: 'Native Flow Buttons' },
    { src: 'docs/ss5.jpg', caption: 'Sistem Premium & XP' },
    { src: 'docs/ss6.jpg', caption: 'Fitur Sticker & Media' },
    { src: 'docs/ss7.jpg', caption: 'Auto Sholat & Tools' },
    { src: 'docs/ss8.jpg', caption: 'Game & RPG System' },
    { src: 'docs/ss9.jpg', caption: 'Anti Spam & Admin Tools' },
  ],
};
...
function buildDocsModal() {
  ...
  // Swipe support
  let startX = 0;
  const sheet = modal.querySelector('.s-docs-hero');
